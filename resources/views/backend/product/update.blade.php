                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-validation">
                                <form class="form-valide" action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                                    @csrf
                                        ...
                                        <div class="col-lg-6">
                                            <select class="form-control" id="val-skill" name="category_id" aria-required="true" aria-describedby="val-skill-error">
                                                ...
                                                @foreach($category as $item)
                                                    @if($item->status == 1)
                                                        <option value="{{ $item->id }}" {{ old('category_id', $product->category_id ?? 0) == $item->id ? "selected" : "" }} style="text-transform: capitalize">{{ $item->name }}</option>
                                                    @else
                                                        {{ NULL }}
                                                    @endif
                                                @endforeach
                                    ...
                                    <div class="form-group row is-invalid">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="name" name="name" value="{{ $product->name }}" aria-required="true" aria-describedby="val-username-error" aria-invalid="true">
                                    ...
                                    <div class="form-group row is-invalid">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="price" name="price" value="{{ $product->price }}" aria-required="true" aria-describedby="val-username-error" aria-invalid="true">
                                            <div id="val-username-error" class="invalid-feedback animated fadeInDown" style="display: block;">
                                        ...
                                        <div class="col-lg-6">
                                            <select class="form-control" id="val-skill" name="unit_id" aria-required="true" aria-describedby="val-skill-error">
                                                ...
                                                @foreach($unit as $item)
                                                    <option value="{{ $item->id }}" {{ old('unit_id', $product->unit_id ?? 0) == $item->id ? "selected" : "" }} style="text-transform: capitalize">{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                            <div id="val-skill-error" class="invalid-feedback animated fadeInDown" style="display: block;">
                                    ...
                                    <div class="form-group row is-invalid">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="name" name="origin" value="{{ $product->origin }}" aria-required="true" aria-describedby="val-username-error" aria-invalid="true">
                                            <div id="val-username-error" class="invalid-feedback animated fadeInDown" style="display: block;">
