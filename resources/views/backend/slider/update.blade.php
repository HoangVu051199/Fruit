            ...
            <div class="card">
               <div class="card-body">
                  <div class="form-validation">
                     <form class="form-valide" action="{{ route('slider.update', $slider->id) }}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        ...
                        <div class="form-group row is-invalid">
                           ...
                           <div class="col-lg-6">
                              <input class="form-control" type="text" name="position" value="{{ $slider->position }}">
                              <div id="val-username-error" class="invalid-feedback animated fadeInDown" style="display: block;">
