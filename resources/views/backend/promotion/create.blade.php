            ...
            <div class="card">
               <div class="card-body">
                  <div class="form-validation">
                     <form class="form-valide" action="{{ route('promotion.store')}}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        <div class="form-group row is-invalid">
                           <label class="col-lg-4 col-form-label" for="val-suggestions">Tên khuyến mãi <span class="text-danger">*</span>
                           </label>
                           <div class="col-lg-6">
                              <input name="name" class="form-control" placeholder="Tên khuyến mãi">
                        ...
                        <div class="form-group row is-invalid">
                           ...
                           <div class="col-lg-3">
                              <input name="sale" class="form-control" placeholder="( % or vnd )">
                              <div id="val-username-error" class="invalid-feedback animated fadeInDown" style="display: block;">
                        ...
                        <div class="form-group row is-invalid">
                           ...
                           <div class="col-lg-6">
                              <input class="form-control" name="start" type="datetime-local" id="example-datetime-local-input">
                              <div id="val-username-error" class="invalid-feedback animated fadeInDown" style="display: block;">
                        ...
                        <div class="form-group row is-invalid">
                           ...
                           <div class="col-lg-6">
                              <input class="form-control" name="finish" type="datetime-local" id="example-datetime-local-input">
                              <div id="val-username-error" class="invalid-feedback animated fadeInDown" style="display: block;">
